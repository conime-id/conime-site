...
export const MOCK_NEWS: NewsItem[] = [
  {
    id: "1",
    title: {
      id: "Perkembangan Terbaru Adaptasi Anime Sakamoto Days",
      en: "Latest Updates on Sakamoto Days Anime Adaptation"
    },
    excerpt: {
      id: "Konfirmasi resmi mengenai tim produksi dan jendela rilis untuk salah satu judul manga paling dinanti tahun 2025.",
      en: "Official confirmation on the production team and release window for one of 2025's most anticipated manga titles."
    },
    content: {id: DUMMY_CONTENT_ID, en: DUMMY_CONTENT_EN},
    category: {id: "Berita", en: "News"},
    subCategory: {id: "Anime", en: "Anime"},
    author: "Redaksi",
    date: { id: "12 Okt 2024", en: "12 Oct 2024" },
    imageUrl:
      "https://images.unsplash.com/photo-1541562232579-512a21360020?q=80&w=1200&auto=format&fit=crop",
    videoUrl: "https://www.youtube.com/embed/sOiMD45QGLs",
    videoLabel: {id: "OFFICIAL TEASER TRAILER", en: "OFFICIAL TEASER TRAILER"},
    imageSource: "TMS Entertainment / Shueisha",
    imageSourceUrl: "https://natalie.mu/comic/news/595000",
    imageCaption: {
      id: "Visual utama promosi anime Sakamoto Days.",
      en: "Main promotional visual for Sakamoto Days anime."
    },
    gallery: [
      {
        url: "https://images.unsplash.com/photo-1578632292335-df3abbb0d586?q=80&w=1000&auto=format&fit=crop",
        caption: {
          id: "Visual konsep karakter utama.",
          en: "Main character concept visual."
        },
      ...
      },
      {
        ...
        videoUrl: "https://www.youtube.com/embed/sOiMD45QGLs",
        videoLabel: {
          id: "EXCLUSIVE ACTION PREVIEW",
          en: "EXCLUSIVE ACTION PREVIEW"
        },
        caption: {
          id: "Teaser Trailer Perdana yang menampilkan aksi koreografi Sakamoto.",
          en: "First Teaser Trailer featuring Sakamoto's action choreography."
        }
      },
      {
        url: "https://images.unsplash.com/photo-1516110833967-0b5716ca1387?q=80&w=1000&auto=format&fit=crop",
        caption: {
          id: "Latar tempat yang terungkap di teaser.",
          en: "Location revealed in the teaser."
        },
        source: "TMS PR"
      }
    ],
    ...
    featured: true,
    tags: [
      { id: "Sakamoto Days", en: "Sakamoto Days" },
      { id: "Adaptasi Anime", en: "Anime Adaptation" },
      { id: "Shonen Jump", en: "Shonen Jump" },
      { id: "TMS Entertainment", en: "TMS Entertainment" }
    ]
  },
  {
    id: "2",
    title: {
      id: "Rekomendasi Manhwa Isekai dengan Narasi Paling Unik di 2024",
      en: "Top Isekai Manhwa Recommendations with Unique Narratives for 2024"
    },
    excerpt: {
      id: "Kurasi komik asal Korea Selatan yang menawarkan perspektif baru pada genre reinkarnasi dan dunia paralel.",
      en: "A curation of South Korean comics offering fresh perspectives on reincarnation and parallel world genres."
    },
    content: {id: DUMMY_CONTENT_ID, en: DUMMY_CONTENT_EN},
    category: {id: "Ulasan", en: "Reviews"},
    subCategory: {id: "Komik", en: "Comics"},
    author: "Staff Editor",
    date: { id: "05 Okt 2024", en: "05 Oct 2024" },
    imageUrl:
      "https://images.unsplash.com/photo-1618336753974-aae8e04506aa?q=80&w=800&auto=format&fit=crop",
    imageSource: "KakaoPage / Webtoon Indonesia",
    imageSourceUrl: "https://webtoon.kakao.com",
    imageCaption: {
      id: "Karakter utama dari salah satu manhwa populer 2024.",
      en: "Main character from one of the popular manhwa in 2024."
    },
    gallery: [
      {
        url: "https://images.unsplash.com/photo-1516110833967-0b5716ca1387?q=80&w=800&auto=format&fit=crop",
        caption: {
          id: "Latar belakang dunia fantasi yang memukau.",
          en: "Stunning fantasy world background."
        }
      }
    ],
    source: "Kakao Webtoon Official",
    sourceUrl: "https://webtoon.kakao.com",
    views: 10200,
    tags: [
      { id: "Manhwa", en: "Manhwa" },
      { id: "Isekai", en: "Isekai" },
      { id: "Webtoon", en: "Webtoon" },
      { id: "Rekomendasi", en: "Recommendations" }
    ]
  },
  {
    id: "3",
    title: {
      id: "Evolusi Visual dan Penulisan Tower of God Musim Kedua",
      en: "Visual and Writing Evolution in Tower of God Season 2"
    },
    excerpt: {
      id: "Bagaimana transisi gaya animasi mempengaruhi penyampaian emosi dan intensitas konflik dalam Menara.",
      en: "How the transition in animation style affects emotional delivery and conflict intensity within the Tower."
    },
    content: {id: DUMMY_CONTENT_ID, en: DUMMY_CONTENT_EN},
    category: {id: "Opini", en: "Opinion"},
    subCategory: {id: "Anime", en: "Anime"},
    author: "Analis",
    date: { id: "13 Okt 2024", en: "13 Oct 2024" },
    imageUrl:
      "https://images.unsplash.com/photo-1578632292335-df3abbb0d586?q=80&w=800&auto=format&fit=crop",
    imageSource: "The Answer Studio / Crunchyroll",
    imageSourceUrl: "https://www.crunchyroll.com/news",
    imageCaption: {
      id: "Perbandingan kualitas animasi Tower of God Season 2.",
      en: "Comparison of Tower of God Season 2 animation quality."
    },
    source: "Naver Webtoon",
    sourceUrl: "https://comic.naver.com",
    views: 7200,
    tags: [
      { id: "Tower of God", en: "Tower of God" },
      { id: "Analisis Anime", en: "Anime Analysis" },
      { id: "Adaptasi Webtoon", en: "Webtoon Adaptation" },
      { id: "Evolusi Visual", en: "Visual Evolution" }
    ]
  },
  {
    id: "4",
    title: {
      id: "Solo Leveling: Arise Menunjukkan Performa Pasar yang Siginifikan",
      en: "Solo Leveling: Arise Demonstrates Significant Market Performance"
    },
    excerpt: {
      id: "Data terbaru mencatat lonjakan pengguna aktif dan stabilitas server pasca pembaruan konten global.",
      en: "Latest data records a surge in active users and server stability post-global content updates."
    },
    content: {id: DUMMY_CONTENT_ID, en: DUMMY_CONTENT_EN},
    category: {id: "Berita", en: "News"},
    subCategory: {id: "Game", en: "Games"},
    author: "Reporter",
    date: { id: "08 Okt 2024", en: "08 Oct 2024" },
    imageUrl:
      "https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=800&auto=format&fit=crop",
    imageSource: "Netmarble Corp.",
    imageSourceUrl: "https://sololeveling.netmarble.com",
    imageCaption: {
      id: "Tampilan antarmuka game Solo Leveling: Arise.",
      en: "Game interface of Solo Leveling: Arise."
    },
    source: "Netmarble PR",
    sourceUrl: "https://netmarble.com",
    views: 5400,
    tags: [
      { id: "Solo Leveling", en: "Solo Leveling" },
      { id: "Game Mobile", en: "Mobile Game" },
      { id: "RPG", en: "RPG" },
      { id: "Netmarble", en: "Netmarble" }
    ]
  },
  {
    id: "5",
    title: {
      id: "Menelusuri Misteri Wilayah Elbaf dalam Cerita One Piece",
      en: "Tracing the Mysteries of Elbaf Territory in One Piece"
    },
    excerpt: {
      id: "Analisis mendalam mengenai signifikansi geografis dan sejarah ras raksasa dalam konklusi cerita.",
      en: "In-depth analysis of the geographical and historical significance of the Giant race in the story's conclusion."
    },
    content: {id: DUMMY_CONTENT_ID, en: DUMMY_CONTENT_EN},
    category: {id: "Berita", en: "News"},
    subCategory: {id: "Komik", en: "Comics"},
    author: "Redaksi",
    date: { id: "14 Okt 2024", en: "14 Oct 2024" },
    imageUrl:
      "https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=800&auto=format&fit=crop",
    imageSource: "Eiichiro Oda / Toei Animation",
    imageSourceUrl: "https://one-piece.com",
    imageCaption: {
      id: "Konsep seni pulau Elbaf yang melegenda.",
      en: "Concept art of the legendary Elbaf island."
    },
    source: "Weekly Shonen Jump",
    sourceUrl: "https://shonenjump.com",
    views: 15600,
    tags: [
      { id: "One Piece", en: "One Piece" },
      { id: "Elbaf", en: "Elbaf" },
      { id: "Analisis Manga", en: "Manga Analysis" },
      { id: "Eiichiro Oda", en: "Eiichiro Oda" }
    ]
  }
];

export const CATEGORIES: CategoryCount[] = [
  {name: {id: "Anime", en: "Anime"}, count: 1},
  {name: {id: "Komik", en: "Comics"}, count: 1},
  {name: {id: "Game", en: "Games"}, count: 1},
  {name: {id: "Film", en: "Movies"}, count: 0},
  {name: {id: "Opini", en: "Opinion"}, count: 1},
  {name: {id: "Ulasan", en: "Reviews"}, count: 1}
];

export const POPULAR_THIS_WEEK: Partial<NewsItem>[] = [
  {
    id: "5",
    title: {
      id: "Menelusuri Misteri Wilayah Elbaf dalam Cerita One Piece",
    ...
    date: { id: "14 Okt 2024", en: "14 Oct 2024" },
    imageUrl:
      "https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=150&h=150&auto=format&fit=crop"
  },
  {
    id: "1",
    title: {
    ...
    date: { id: "12 Okt 2024", en: "12 Oct 2024" },
    imageUrl:
      "https://images.unsplash.com/photo-1541562232579-512a21360020?q=80&w=150&h=150&auto=format&fit=crop"
  },
  {
    id: "2",
    title: {
      id: "Rekomendasi Manhwa Isekai dengan Narasi Paling Unik",
      en: "Top Isekai Manhwa Recommendations"
    },
    category: {id: "Ulasan", en: "Reviews"},
    subCategory: {id: "Komik", en: "Comics"},
    date: { id: "05 Okt 2024", en: "05 Oct 2024" },
    imageUrl:
      "https://images.unsplash.com/photo-1618336753974-aae8e04506aa?q=80&w=150&h=150&auto=format&fit=crop"
  },
  {
    id: "3",
    title: {
      id: "Evolusi Visual Tower of God Musim Kedua",
      en: "Visual Evolution in Tower of God S2"
    },
    category: {id: "Opini", en: "Opinion"},
    subCategory: {id: "Anime", en: "Anime"},
    date: { id: "13 Okt 2024", en: "13 Oct 2024" },
    imageUrl:
      "https://images.unsplash.com/photo-1578632292335-df3abbb0d586?q=80&w=150&h=150&auto=format&fit=crop"
  },
  {
    id: "4",
    title: {
      id: "Solo Leveling: Arise Performa Pasar Siginifikan",
      en: "Solo Leveling Arise Market Success"
    },
    category: {id: "Berita", en: "News"},
    subCategory: {id: "Game", en: "Games"},
    date: { id: "08 Okt 2024", en: "08 Oct 2024" },
    imageUrl:
      "https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=150&h=150&auto=format&fit=crop"
  }
];
